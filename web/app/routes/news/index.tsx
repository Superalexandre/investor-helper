...
import { NewsFull } from '../../../types/News'
  ...
  loader() {
    return {
      ...
      newsPreferences: {
        ...
        sources: [
          "afp", "reuters", "boursier.com", "invezz", "cointribune", "beincrypto", "cointelegraph", "coin academy", "boursier_com", "globenewswire", "newsfile corp."
        ]
      },
      allSources: [
        "afp", "reuters", "boursier.com", "invezz", "cointribune", "beincrypto", "cointelegraph", "coin academy", "boursier_com", "globenewswire", "newsfile corp."
...
function RouteComponent(): ReactNode {
  const { newsPreferences, allSources } = useLoaderData({
    from: "/news/"
  })
