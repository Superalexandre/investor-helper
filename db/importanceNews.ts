...
import { newsArticle as newsArticleSchema, newsRelatedSymbols as newsRelatedSymbolsSchema, news as newsSchema } from "./schema/news.js"
...
async function importanceNews() {
    ...
    for (const n of news) {
        const article = await db
            ...
            .where(
                eq(newsArticleSchema.newsId, n.id)
            )
        ...
        const relatedSymbols = await db
            ...
            .where(
                eq(newsRelatedSymbolsSchema.newsId, n.id)
            )
