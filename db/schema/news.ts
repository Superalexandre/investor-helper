...
export const news = sqliteTable("news", {
	...
	sourceLogoId: text("source_logo_id").notNull(),
	published: int("published").notNull(),
	source: text("source").notNull(),
	urgency: int("urgency").notNull(),
	provider: text("provider").notNull(),
	link: text("link"),
	mainSource: text("main_source").notNull().default("tradingview"),
	lang: text("lang").notNull().default("fr-FR"),
...
export const newsArticle = sqliteTable("news_article", {
	...
	//     .notNull(),
	jsonDescription: text("json_description").notNull(),
